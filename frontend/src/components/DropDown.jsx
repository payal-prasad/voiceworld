                  ...
                  <div className="bg-gray-350 rounded-lg">
                    <div>
                      <div className="flex flex-col">
                        ...
                        {micOn ? (
                          <div
                            className={`my-1  text-white flex ${
                              isMobile ? "flex-col" : "flex-1"
                            } w-full text-left mb-2 pl-2`}
                          >
                            <div
                            ...
                            >
                              ...
                              <div
                                className={`${
                                  isMobile ? "w-full mr-5" : "w-36"
                                } mt-3 bg-gray-450 rounded-full h-1 dark:bg-gray-700`}
                              >
                                <div
                            ...
                            {!isMobile && (
                              ...
                              >
                                {recordingStatus == "inactive" && (
                                  <button
                                    className=" p-2 text-xs rounded  bg-gray-450"
                                ...
                                {recordingStatus == "recording" && (
                                  <button
                                    className=" p-2 mx-1 py-4 text-xs rounded w-full  bg-gray-450 relative z-0"
                                    onClick={stopRecording}
                                  >
                                    <div
                                      className=" h-full rounded bg-[#6F767E] absolute top-0 left-0 "
                            ...
                            {isMobile && (
                              <div className="flex flex-col mt-1 items-center justify-center">
                                ...
                                <button
                                  className="p-2 text-xs mt-1 rounded w-fit  bg-gray-450"
